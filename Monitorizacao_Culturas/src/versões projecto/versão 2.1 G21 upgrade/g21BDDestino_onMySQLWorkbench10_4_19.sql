...
-- ---------------------------------DESTINO-G1--------------------------
DROP ROLE IF EXISTS 'Auditor', 'MigradorLog';
CREATE ROLE IF NOT EXISTS 'Auditor', 'MigradorLog';

GRANT SELECT ON g21destino.log_variaveis TO 'MigradorLog';
GRANT SELECT ON g21destino.log_cultura TO 'MigradorLog';
GRANT SELECT ON g21destino.log_investigador TO 'MigradorLog';
GRANT SELECT ON g21destino.log_administrador TO 'MigradorLog';
GRANT SELECT ON g21destino.log_variaveismedidas TO 'MigradorLog';
GRANT SELECT ON g21destino.log_medicoes TO 'MigradorLog';
GRANT SELECT ON g21destino.log_medicoesluz TO 'MigradorLog';
GRANT SELECT ON g21destino.log_medicoestemp TO 'MigradorLog';
GRANT SELECT ON g21destino.log_sistema TO 'MigradorLog';
GRANT SELECT ON g21destino.log_migracao TO 'MigradorLog';

GRANT INSERT ON g21destino.log_variaveis TO 'MigradorLog';
GRANT INSERT ON g21destino.log_cultura TO 'MigradorLog';
GRANT INSERT ON g21destino.log_investigador TO 'MigradorLog';
GRANT INSERT ON g21destino.log_administrador TO 'MigradorLog';
GRANT INSERT ON g21destino.log_variaveismedidas TO 'MigradorLog';
GRANT INSERT ON g21destino.log_medicoes TO 'MigradorLog';
GRANT INSERT ON g21destino.log_medicoesluz TO 'MigradorLog';
GRANT INSERT ON g21destino.log_medicoestemp TO 'MigradorLog';
GRANT INSERT ON g21destino.log_sistema TO 'MigradorLog';
GRANT INSERT ON g21destino.log_migracao TO 'MigradorLog';
