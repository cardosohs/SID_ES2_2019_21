...
BEGIN
	...
	values (new.idadmin,new.email,new.nomeadmin,CURRENT_TIMESTAMP,'I',current_user());
END$$
...
BEGIN
	insert into log_administrador(IdAdmin,Email,NomeAdmin,DataHoraLog,Operacao,Autor) 
	values (new.idadmin,new.email,new.nomeadmin,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
		insert into log_administrador(IdAdmin,Email,NomeAdmin,DataHoraLog,Operacao,Autor) 
	values (old.idadmin,old.email,old.nomeadmin,CURRENT_TIMESTAMP,'D',current_user());
...
BEGIN
	...
	values (new.idinvestigador,new.email,new.nomeinvestigador,new.categoriaprofe,CURRENT_TIMESTAMP,'I',current_user());
END$$
...
BEGIN	
	insert into log_investigador(IdInvestigador,Email,NomeInvestigador,CategoriaProfe,DataHoraLog,Operacao,Autor) 
	values (new.idinvestigador,new.email,new.nomeinvestigador,new.categoriaprofe,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
	insert into log_investigador(IdInvestigador,Email,NomeInvestigador,CategoriaProfe,DataHoraLog,Operacao,Autor) 
	values (old.idinvestigador,old.email,old.nomeinvestigador,old.categoriaprofe,CURRENT_TIMESTAMP,'D',current_user());
END$$
...
BEGIN
	...
	values (new.idcultura,new.idinvestigador,new.nomecultura,new.descricaocultura,CURRENT_TIMESTAMP,'I',current_user());
END$$
...
BEGIN
	insert into log_cultura(IdCultura,IdInvestigador,NomeCultura,DescricaoCultura,DataHoraLog,Operacao,Autor) 
	values (new.idcultura,new.idinvestigador,new.nomecultura,new.descricaocultura,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
	insert into log_cultura(IdCultura,IdInvestigador,NomeCultura,DescricaoCultura,DataHoraLog,Operacao,Autor) 
	values (old.idcultura,old.idinvestigador,old.nomecultura,old.descricaocultura,CURRENT_TIMESTAMP,'D',current_user());
END$$
...
BEGIN
	...
	values (new.idvariavel,new.nomevariavel,CURRENT_TIMESTAMP,'I',current_user());
END$$
...
BEGIN
	insert into log_variaveis(IdVariavel,NomeVariavel,DataHoraLog,Operacao,Autor) 
	values (new.idvariavel,new.nomevariavel,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
	insert into log_variaveis(IdVariavel,NomeVariavel,DataHoraLog,Operacao,Autor) 
	values (old.idvariavel,old.nomevariavel,CURRENT_TIMESTAMP,'D',current_user());
END$$
...
BEGIN
	...
	values (new.idvarmed,new.idcultura,new.idvariavel,new.limiteinferior,new.limitesuperior,CURRENT_TIMESTAMP,'I',current_user());
...
BEGIN
	insert into log_variaveismedidas(IdVarMed,IdCultura,IdVariavel,LimiteInferior,LimiteSuperior,DataHoraLog,Operacao,Autor) 
	values (new.idvarmed,new.idcultura,new.idvariavel,new.limiteinferior,new.limitesuperior,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
	insert into log_variaveismedidas(IdVarMed,IdCultura,IdVariavel,LimiteInferior,LimiteSuperior,DataHoraLog,Operacao,Autor) 
	values (old.idvarmed,old.idcultura,old.idvariavel,old.limiteinferior,old.limitesuperior,CURRENT_TIMESTAMP,'D',current_user());
END$$
...
BEGIN
	...
	values (new.idmed,new.idvarmed,new.datahoramed,new.valormed,CURRENT_TIMESTAMP,'I',current_user());
END$$
...
BEGIN
	insert into log_medicoes(IdMed,IdVarMed,DatahoraMed,ValorMed,DataHoraLog,Operacao,Autor) 
	values (new.idmed,new.idvarmed,new.datahoramed,new.valormed,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
	insert into log_medicoes(IdMed,IdVarMed,DatahoraMed,ValorMed,DataHoraLog,Operacao,Autor) 
	values (old.idmed,old.idvarmed,old.datahoramed,old.valormed,CURRENT_TIMESTAMP,'D',current_user());
END$$
...
BEGIN
	...
	values (new.idmedicao,new.valormedicaoluz,new.datahoramed,CURRENT_TIMESTAMP,'I',current_user());
END$$
...
BEGIN
	insert into log_medicoesluz(IdMedicao,ValorMedicaoLuz,DataHoraMed,DataHoraLog,Operacao,Autor) 
	values (new.idmedicao,new.valormedicaoluz,new.datahoramed,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
	insert into log_medicoesluz(IdMedicao,ValorMedicaoLuz,DataHoraMed,DataHoraLog,Operacao,Autor) 
	values (old.idmedicao,old.valormedicaoluz,old.datahoramed,CURRENT_TIMESTAMP,'D',current_user());
END$$
...
BEGIN
	...
	values (new.idmedicao,new.datahoramed,new.valormedicaotemp,CURRENT_TIMESTAMP,'I',current_user());
END$$
...
BEGIN
	insert into log_medicoestemp(IdMedicao,DataHoraMed,ValorMedicaoTemp,DataHoraLog,Operacao,Autor) 
	values (new.idmedicao,new.datahoramed,new.valormedicaotemp,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
	insert into log_medicoestemp(IdMedicao,DataHoraMed,ValorMedicaoTemp,DataHoraLog,Operacao,Autor) 
	values (old.idmedicao,old.datahoramed,old.valormedicaotemp,CURRENT_TIMESTAMP,'D',current_user());
END$$
...
BEGIN
	...
	values (new.idsistema,new.limiteinferiortemp,new.limitesuperiortemp,new.limiteinferiorluz,new.limitesuperiorluz,CURRENT_TIMESTAMP,'I',current_user());
END$$
...
BEGIN
	insert into log_sistema(IdSistema,LimiteInferiorTemp,LimiteSuperiorTemp,LimiteInferiorLuz,LimiteSuperiorLuz,DataHoraLog,Operacao,Autor) 
	values (new.idsistema,new.limiteinferiortemp,new.limitesuperiortemp,new.limiteinferiorluz,new.limitesuperiorluz,CURRENT_TIMESTAMP,'U',current_user());
END$$
...
BEGIN
	insert into log_sistema(IdSistema,LimiteInferiorTemp,LimiteSuperiorTemp,LimiteInferiorLuz,LimiteSuperiorLuz,DataHoraLog,Operacao,Autor) 
	values (old.idsistema,old.limiteinferiortemp,old.limitesuperiortemp,old.limiteinferiorluz,old.limitesuperiorluz,CURRENT_TIMESTAMP,'D',current_user());
END$$
...
begin
select * from medicoes where IdCultura = culturaID and DataHoraMed like CONCAT("%",DataIn,"%");
end+
delimiter ;
